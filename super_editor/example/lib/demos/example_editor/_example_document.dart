...
Document createInitialDocument(c.ChildrenDocument childrenDocument) {
  return MutableDocument(
    nodes: List.generate(childrenDocument.children!.length, (index) {
      return  ParagraphNode(
        id: childrenDocument.children![index].id ?? '',
        text: AttributedText(
          text: childrenDocument.children![index].text ?? '',
        ),
        metadata: {
